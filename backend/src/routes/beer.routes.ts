...
import { BeerRequestOptions } from '../interfaces/Beer/beer.interfaces';
...
import UpdateBeerImageService from '../services/BeerServices/UpdateBeerImageService';
...
beerRouter.delete('/beer', async (request, response) => {
  try {
    ...
    const { beer_id, brewer_id }: BeerRequestOptions = parsedParams;
